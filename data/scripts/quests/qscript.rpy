...
label startquest:
    ...
    call createlog from _call_createlog

    scene bg pink with fade

    e "Hello, and welcome to the tech demo of the Questlog class by jw2pfd."

    e "My name is Eileen; primarily because it's just easier that way."

    e """The quest log has been created in the code, but you haven't been given any quests yet.  This means
       the log isn't accesible right now."""

    e "I can help get you started!"

    menu:
        e "Are you ready to take on a quest?"

        "Yes":
            e "Great!"
        "No":
            e "Well, that'd make a really pointless tech demo."
            e "Sooooo, I'm going to give you a quest anyway."

    e "Right now we're in the park... Oh, yeah, there aren't any backgrounds."

    $ room = "pink"

    e "Hmm, okay, so we're in the pink room.  There are three other rooms: yellow, blue, and green."

    e "My friends Peter, Paul, and Mary need help with various things.  Go and talk to each of them."

    e "Once you have helped out all of them, return to me and I'll reward you by terminating this terrible demo."

    $ log.keyon()
    $ log.assign("Eileen's Quest")

    show screen tracker

    e """Now you should be able to access the log by pressing the 'Q' key or clicking the Quests quick menu bottom at the
       bottom right of the dialogue box."""

    e "To close the Quests menu, you can press Q, escape, right-click, or the X at the top right of the log."

    e "Go explore the others rooms and work to complete quests.  Remember to return to me when you're done."
