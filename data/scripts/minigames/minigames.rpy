...
label startereng:
    ...
    pause .5
    show expression Text("Ready ?!") at truecenter as txt
    with dissolve
    pause
    hide txt
    ...
    if _return:
        ...
        with flash
        show expression Text("You won !") at truecenter as txt
    else:
        ...
        scene expression (img_name + "0")
        with flash2
        show expression Text("You lost !") at truecenter as txt
