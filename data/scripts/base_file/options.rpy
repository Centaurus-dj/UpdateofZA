...
define config.name = _("{color=#f9300c}Zombie Apocalypse{/color}")
...
if _preferences.language == None:
    jump about_fr
label about_fr:
    define gui.aboutfr = _p("""{font=fonts/thunderstrike.ttf}
...
label about_eng:
    define gui.abouteng = _p("""{font=fonts/thunderstrike.ttf}
...
define build.name = "{color=#f9300c}Zombie Apocalypse{/color}"
