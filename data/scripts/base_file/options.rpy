...
## Base de l'affichage, si True le jeu est automatiquement en plein écran
## si False le jeu est automatiquement en fenêtré
init -3:
...
define config.name = _("Zombie Apocalypse")
...
#init -2 python:
#    config.mouse = { "default": [ (im.Scale("/data/images/mouse/cursor.png", 50, 50), 5, 5) ] }
...
define config.window_icon = "/data/images/pc/app icon/game.png"
...
if _preferences.language == None:
    jump about_fr
label about_fr:
    define gui.aboutfr = _p("""{font=data/fonts/thunderstrike.ttf}
    \n\n{color=#09c636}Remerciements à :{/color}
    \n{color=#09c636}-{b}Henri C.{/b}(DRH)
    \n-Daph{/color}
    \n{color=#f9300c}-{i}Camille R.{/i}{/color}
    \n{color=#57daf2}-Jade O.{/color}
    \n{color=#57daf2}-Camille O.{/color}
    \n\net à tous les autres contributeurs du projet Zombie Apocalypse
    \n{color=#f9300c}Codage:
    \n-Alexis O.{/color}
    \n
    {/font}
...
label about_eng:
    define gui.abouteng = _p("""{font=data/fonts/thunderstrike.ttf}
    \n\n{color=#09c636}Thanks to :{/color}
    \n{color=#09c636}-{b}Henri C.{/b}(DRH)
    \n-Daph{/color}
    \n{color=#f9300c}-{i}Camille R.{/i}{/color}
    \n{color=#57daf2}-Jade O.{/color}
    \n{color=#57daf2}-Camille O.{/color}
    \n\nand to others contributors of Zombie Apocalypse project
    \n{color=#f9300c}Coding:
    \n-Alexis O.{/color}
    \n
    {/font}
...
define build.name = "Zombie Apocalypse"
...
define config.main_menu_music = audio.Menu_Music
...
define config.save_directory = "ZombieApocalypse-die_in_world"
...
define build.google_play_key = "AIzaSyD8z7MII0rBrLrfkDgoSBi4rSPZeCikXcQ"


## Le nom d’utilisateur et du projet associé au projet itch.io, séparé par un
## slash.

define build.itch_project = "centaurus/humanity-games-zombie-apocalypse"


## Les raccourcis claviers
init -3:
    $ config.keymap['game_menu'].append('s')
