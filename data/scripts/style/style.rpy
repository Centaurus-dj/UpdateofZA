...
style Startabouttext:
    font "data/fonts/Photograph Signature.ttf"
    size 60
    xpos .05
    ypos .1
    color "#F6080c"
...
style kashima:
    font "data/fonts/Kashima Demo.otf"
    color "#ffffff"
    hover_color "#f80e0e"
...
style zenzai:
    font "data/fonts/Zenzai Itache.ttf"
    color "#ffffff"
    hover_color "#f80e0e"
    selected_color "#f9300c"
    selected_hover_color "#cc0000"
...
style main_menu_statement:
    font "data/fonts/Cyberpunks.ttf"
    color "#e6e6e6"
    yalign 1.0
    xalign 1.0
    size 30

style game_statement:
    font "data/fonts/Cyberpunks.ttf"
    color "#e6e6e6"
    yalign 1.0
    xalign 0.0
...
style MainMenu_butt:
    background "gui/button/mainmenu_bg.png"
