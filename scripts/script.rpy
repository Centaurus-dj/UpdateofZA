...
label script_fr:
    ...
    $ renpy.pause()
    hide screen Startabout
    with fade
    show screen Startaboutcont()
    $ renpy.pause()
    hide screen Startaboutcont
    with fade
    show screen Startaboutcont2()
    $renpy.pause()
    hide screen Startaboutcont2
    with fade
    show screen Startaboutcont3()
    $ renpy.pause()
    hide screen Startaboutcont3
    jump dbut_hist_choix_test


label dbut_hist_choix_test:
    n "test"
    menu:
        note "Que faire...."
        ...
        "Positive choice" ("pos"):
            note "your choice was [alignment]"
            jump dbut_hist_choix_test
...
label hist_continue_debut_presplash:
    show screen reshist_fr() with fade
    $ renpy.pause()
    hide screen reshist_fr with fade
    show screen reshist2_fr() with fade
    $ renpy.pause()
    hide screen reshist2_fr with fade

label choix_intro:
    menu:
        "Avant tout, qui es-tu ?"
        "Je suis une femme !":
            $ persistent.MC_genre = "girl"
            jump Sstart_story
        "Je suis un homme !":
            $ persistent.MC_genre = "guy"
            jump Sstart_story
        "Je suis un alien !":
            $ persistent.MC_genre = "alien"
            jump Sstart_story
...
label Sstart_story:
    ...
    if persistent.MC_genre == "girl":
        ...
        if nomduheros.strip() in prenom_masc:
            a "Tu es sérieux ?!"
            jump Start_story
        ...
        if nomduheros.strip() in prenoms_insulte:
            a "Tu me dégoutes !!"
            a "Recommence !"
