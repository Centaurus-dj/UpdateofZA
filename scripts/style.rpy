...
init -2:
    ...
    style say_named:
        background Image("gui/textbox_name.png")

    style say_noname:
        background Image("gui/textbox_noname.png")
...
style raidercrusader:
    font "fonts/raidercrusaderhalf.ttf"
    hover_color "#f80e0e"
...
style thunderstrike_lbl:
    font "fonts/thunderstrikeitalic.ttf"
    color "#b00101"
    size 20

style thunderstrike:
    font "fonts/thunderstrike.ttf"
    hover_color "#f80e0e"
...
style main_menu_frame:
    ...
    background "gui/menu_2_t.jpg"
        imagebutton:
            idle "/images/imgbttns/btns.png"
            hover "/images/imgbttns/btns_hover.png"
            action OpenURL()
...
style game_menu_outer_frame2:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_1.jpg"

style game_menu_outer_frame3:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_3.jpg"

style game_about_frame:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_5.jpg"

style game_menu_plus_1_frame:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_3_modif.jpg"
...
style game_menu_plus_3_frame:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_5_modif.jpg"

style game_menu_plus_4_frame:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_6_modif.jpg"

style game_menu_outer_frame5:
    bottom_padding 45
    top_padding 180
    background "images/background/menu_6.jpg"
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "gui/frame_cust.png"], gui.confirm_frame_borders, tile=gui.frame_tile)
...
style window:
    variant "small"
    background "gui/phone/textbox_modif.png"
...
style game_menu_outer_frame:
    variant "small"
    background "images/background/menu_4_modif.jpg"
